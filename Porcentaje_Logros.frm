...
Begin VB.Form Porcentaje_Logros 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Combo2 
         ...
         Left            =   1080
         List            =   "Porcentaje_Logros.frx":0475
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   720
         Width           =   1935
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   735
      Left            =   8760
      Picture         =   "Porcentaje_Logros.frx":0477
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   5040
      Width           =   1095
...
For J = 0 To 3
    ...
    Else
        ...
        'Se verifica si está bloqueado el periodo para bloquear la matriz
        If VeriPeriodo(J + 1, "periodosL") = False Then
            Mtx_ptj(J).Enabled = False
        End If
