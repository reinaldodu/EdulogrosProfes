...
Begin VB.Form INFREFINAL 
   ...
   Caption         =   "Comentarios del director de grupo para el informe final"
   ClientHeight    =   6180
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7215
...
If Dir(Ruta & Combo1.Text & ".gru") = "" Then
    MsgBox "Grupo no le corresponde"
    Exit Sub
End If
...
List1.ToolTipText = "[" & (List1.ListIndex + 1) & "] " & Mid(List1.List(List1.ListIndex), 1, 120)
