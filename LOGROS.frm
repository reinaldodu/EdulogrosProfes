...
Begin VB.Form LOGROS 
   ...
   Begin VB.CommandButton Command7 
      ...
      Left            =   7440
      TabIndex        =   9
      ToolTipText     =   "Borra todas las observaciones existentes."
      Top             =   4920
      Width           =   1335
   End
...
End If
NAR = FreeFile
Open "a:\datos\" & fl & ser & Val(Text1.Text) & lw & ".lgr" For Random As #NAR Len = Len(logru)
logru.indicador = Format(Combo3.Text, ">")
logru.observ = Text4.Text
Put #NAR, Text3.Text, logru
If Err.Number = 70 Then
MsgBox "EL DISKETTE ESTA PROTEGIDO CONTRA ESCRITURA, NO SE HA GURDADO LA OBSERVACION.  RETIRELO, DESPROTEJALO Y VUELVA A GUARDAR.", 16, "ADVERTENCIA"
GoTo SALUD
End If
...
cli = Val(Text1.Text)
NAR = FreeFile
Open "a:\datos\materia.edu" For Random As #NAR Len = Len(mate)
que = 0
While Not EOF(NAR)
que = que + 1
Get #NAR, que, mate
...
Close #NAR
cona = 0
Open "a:\datos\areagra.edu" For Random As #NAR Len = Len(argra)
While Not EOF(NAR)
cona = cona + 1
Get #NAR, cona, argra
If (argra.num_pro = clavv.NUMERO) And (RTrim(argra.grado) = RTrim(Combo2.Text) And (argra.num_area = Val(Text1.Text))) Then
Close #NAR
GoTo intel
End If
Wend
...
Open "a:\datos\" & fl & ser & Val(Text1.Text) & lw & ".lgr" For Random As #NAR Len = Len(logru)
If Err.Number = 70 Then
MsgBox "DISKETTE ESTA PROTEGIDO CONTRA ESCRITURA", 16, "ADVERTENCIA"
GoTo EX44
End If
If Err.Number = 61 Then
MsgBox "EL DISKETTE ESTA LLENO NO SE GUARDO LA INFORMACION", 16, "ADVERTENCIA"
...
GoTo NOLO
End If
If Dir("a:\datos\" & fl & ser & Val(Text1.Text) & lw & ".lgr") = "" Then
MsgBox "NO EXISTEN OBSERVACIONES DEL PERIODO " & Combo4.Text, 32, "COPIAR OBSERVACIONES"
Combo4.SetFocus
GoTo NOLO
End If
FileCopy "a:\datos\" & fl & ser & Val(Text1.Text) & lw & ".lgr", "a:\datos\" & fl & ser2 & Val(Text1.Text) & lw2 & ".lgr"
If Err.Number = 70 Then
...
RESP = MsgBox("DESEA REALIZAR LA COPIA PARA EL PERIODO " & Combo6.Text & " DE " & Combo5.Text & "?", vbYesNo + vbQuestion + vbDefaultButton1, "COPIAR LOGROS")
If RESP = vbYes Then
FileCopy "a:\datos\" & fl & ser & Val(Text1.Text) & lw & ".lgr", "c:\" & fl & ser2 & Val(Text1.Text) & lw2 & ".lgr"
If Err.Number = 71 Then
MsgBox "INSERTE EL DISKETTE FUENTE EN LA UNIDAD A.", 16, "ADVERTENCIA"
GoTo NOLO
End If
If Err.Number = 53 Then
MsgBox "EL DISKETTE FUENTE NO CORRESPONDE", 16, "ADVERTENCIA"
GoTo NOLO
End If
...
Kill "c:\" & fl & ser2 & Val(Text1.Text) & lw2 & ".lgr"
GoTo NOLO
End If
FileCopy "c:\" & fl & ser2 & Val(Text1.Text) & lw2 & ".lgr", "a:\datos\" & fl & ser2 & Val(Text1.Text) & lw2 & ".lgr"
If Err.Number = 70 Then
MsgBox "EL DISKETTE ESTA PROTEGIDO CONTRA ESCRITURA, NO SE REALIZO LA COPIA.", 16, "ADVERTENCIA"
Kill "c:\" & fl & ser2 & Val(Text1.Text) & lw2 & ".lgr"
GoTo NOLO
...
PASSW.Show 1
If i = 1 Then
RESP = MsgBox("DESEA BORRAR LAS OBSERVACIONES DE " & Frame1.Caption & "?", vbYesNo + vbQuestion + vbDefaultButton2, "ADVERTENCIA")
If RESP = vbYes Then
On Error Resume Next
Err.Clear
If Dir("a:\datos\inicial.edu") = "" Then
...
End If
If Dir("a:\datos\" & fl & ser & Val(Text1.Text) & lw & ".lgr") <> "" Then
Kill "a:\datos\" & fl & ser & Val(Text1.Text) & lw & ".lgr"
MsgBox "OBSERVACIONES BORRADAS"
Text5.Text = 0
Text3.Text = 1
Else
MsgBox "NO EXISTEN OBSERVACIONES PARA BORRAR"
End If
End If
End If
CHAOSS:
...
PASSW.Show 1
If i = 1 Then
COPEGA.Label2.Caption = "a:\datos\" & fl & ser & Val(Text1.Text) & lw & ".lgr"
