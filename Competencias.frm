...
Begin VB.Form Competencias 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "Competencias.frx":0004
         Left            =   960
         List            =   "Competencias.frx":0014
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   360
         Width           =   1575
...
While Not EOF(NAR)
    cona = cona + 1
    Get #NAR, cona, argra
    If (argra.num_pro = Val(MENUPROFE.LBLNumProfe.Caption)) And (RTrim(argra.grado) = RTrim(Combo2.Text) And (argra.num_area = que)) Then
        Close #NAR
        GoTo intel
    End If
Wend
