...
Public RECO As Boolean, CED As String, QQ As Integer, CUCU As Integer, DF As Integer, re32 As String, seri As String, noar As String, lwe As Integer, fl As Integer, cru As Integer, tensi As Integer, pp As Integer, zz As Integer, uu As Integer, xo As Integer, yi As Integer, rus As Integer, fis As Integer, clav As Integer, malo As Integer, giti As Integer, gli As Integer, CONTAREA As Integer, jis As Integer, noyu As Integer, ver As Integer, JOJI As String, SAPO As String, SAPO2 As String, SAPO3 As String, TOS As Integer, CX As Single, CY As Single, NAR As Integer, DISP As Integer, J3 As Integer
